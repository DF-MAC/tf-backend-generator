...
variable "default_region" {
  description = "The default region to use for resources that are not region-specific."
  type        = string
  default     = "us-east-1"
...
variable "default_profile" {
  description = "The default profile to use for resources that are not profile-specific."
  type        = string
  default     = "Mac"
}

variable "replica_region" {
  description = "The region to replicate the S3 bucket to."
  type        = string
  default     = "us-west-2"
}
...
variable "terraform_iam_policy_create" {
  description = "Specifies whether terraform IAM policy is created."
  type        = bool
  default     = true
}

# TODO: Set default as needed
variable "terraform_iam_policy_name_prefix" {
  description = "Creates a unique name beginning with the specified prefix."
  type        = string
  default     = "df-tf-remote-state-policy"
}
